        ...
        do {
            ...
            when (role) {
                ...
                "1"      -> {
                    ...
                    captain = captainName // Task 7 and 8
                    printCrew()
                    roleLoopDone = true
                }
                "2"      -> {
                    ...
                    firstOfficer = firstOfficerName // Task 7 and 8
                    printCrew()
                    roleLoopDone = true
                }
                "3"      -> {
                    ...
                    attendants.add(attendantName) // Task 7 and 8
                    printCrew()
                    roleLoopDone = true
                }
...
fun subMenuManifest() {
    ...
    for (index in 0 until totalSeats) {
        if (!isSeatAvailable(index)) {
            ...
            val seatDesc: String = getSeatDesignatorFromIndex(index) + " " + "[passenger's name]"
            println(seatDesc)
            seatsBooked ++
        }
    }
